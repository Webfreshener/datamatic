...
ValidatorBuilder = (function() {
  function ValidatorBuilder() {
          ...
          for (i = 0, len = _v.length; i < len; i++) {
            ...
            switch (typeof value) {
              case 'string':
                ...
                if ((vItm.restrict != null) && vItm.restrict === true) {
                  return ((new RegExp(vItm.restrict)).exec(value)) != null;
                }
                return true;
              case 'function':
    ...
    this.exec = function(_path, value) {
      return typeof _validators[_path] === "function" ? _validators[_path](value != null ? value : "validator for '" + path + "' does not exist") : void 0;
    };
  }
