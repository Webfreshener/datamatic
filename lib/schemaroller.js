...
_global.SchemaRoller = function () {
                ...
                if (_oKey !== "elements") {
                  ...
                  try {
                    for (var _iterator2 = Object.keys(_schema[_oKey])[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                      ...
                      if (typeof (_errorMsg = this.validateSchemaEntry(_x4, _schema[_oKey][_x4])) === "string") {
                        return _errorMsg;
                      }
                    }
                  } catch (err) {
  ...
  var BaseValidator = function () {
    ...
    _createClass(BaseValidator, [{
      ...
      value: function checkType(type, value) {
        return;
        if (_exists(type)) {
          var _x5 = typeof type !== "string" ? _schemaroller_.getClass(type) : type;
          if (!_exists(_x5.match(new RegExp("^" + (typeof value === "undefined" ? "undefined" : _typeof2(value)) + "$", "i")))) {
    ...
    _createClass(Obj, [{
      ...
      value: function exec(value) {
        if (!Array.isArray(value)) {
          ...
          for (var _ in this.value) {
            var e = this.call(this.path, this.value[_]);
            if (typeof e === 'string') {
              return e;
            }
          }
      ...
      */
      ...
      value: function unshift() {
        ...
        items.forEach(function (item) {
          return _this8.setItemAt(0, item);
        });
        return this;
      }
      /**
  ...
  var SchemaHelpers = function () {
    ...
    _createClass(SchemaHelpers, [{
      ...
      value: function createSchemaChild(key, opts, metaData) {
        var _kinds;
        //	  console.log(`this._ref.signature for ${key}:\n${JSON.stringify( this._ref.signature , null, 2)}`);
        var _schemaDef = _exists(this._ref.signature.elements) ? this._ref.signature.elements : this._ref.signature["*"] || this._ref.signature;
      ...
      value: function setChildObject(key, schema, value) {
        ...
        var _s = this.createSchemaChild(key, this._ref.options, _mdData);
        if (typeof _s === "string") {
          return _s;
        }
      ...
      key: "walkSchema",
      value: function walkSchema(schema, path) {
        var _this10 = this;

        var result = [];
        var _map = function _map(_schema, _path) {
          return _this10.walkSchema(_schema, _path);
        };
        var _elements = Array.isArray(schema) ? schema : Object.keys(schema);
        for (var _i in _elements) {
          var _key = _elements[_i];
          var _signature = schema[_key];
          var schemaPath = _exists(path) ? path.length ? path + "." + _key : _key : _key || "";
  ...
  var Schema = function () {
    ...
    function Schema(_signature) {
      ...
      if (_exists(_signature.elements)) {
        ...
        try {
          for (var _iterator10 = Object.keys(_signature.elements)[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
