...
const tasks = [() => {
    ...
    let result = obj.model.topScores.$model.validate([{
        name: "Player 4",
        score: 12300000,
    }, {
        name: "Player 5",
    ...
    try {
        ...
        console.log("\n\t>> throws error:", JSON.stringify(e));
    }

    // outputs to confirm no change to state
    console.log("\tscore was not incremented\n\tcurrent value:", obj.model.topScores[0].score);
}];
