...
_global.SchemaRoller = function () {
      ...
      */
      ...
      value: function unshift() {
        ...
        items.forEach(function (item) {
          return _this3.setItemAt(0, item);
        });
        return this;
      }
      /**
  ...
  var Schema = function () {
    ...
    _createClass(Schema, [{
      ...
      value: function set(key, value) {
        ...
        var k;
        var _hasRequiredFields = function _hasRequiredFields(obj) {
          ...
          try {
            for (var _iterator12 = _this5.requiredFields[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
              var _key5 = _step12.value;

              var _path = _this5.path.length ? _this5.path : "root element";
              if (oKeys.indexOf(_key5) === -1) {
                return 'required property \'' + _key5 + '\' is missing for \'' + _path + '\'';
              }
            }
          } catch (err) {
        ...
        if ((typeof key === 'undefined' ? 'undefined' : _typeof(key)) === 'object') {
          var _ = _hasRequiredFields(Object.assign({}, _object, key));
          if (typeof _ === 'string') {
            return _;
          }
          // calls set with nested key value pair
          for (k in key) {
            var _4 = this.set(k, key[k]);
            if (typeof _4 === 'string') {
              return _4;
            }
          }
        ...
        // handles strings passed as key
            ...
            var _o = this.signature;
            var _schema = _exists(_o.elements) ? _o.elements : _o;
            var _extensible = _exists(_o.extensible) ? _o.extensible : this.options.extensible || false;
            var _pathKeys = key.split('.');
            for (var _k2 in _pathKeys) {
              var _elKey = _schema[_pathKeys[_k2]];
              if (_exists(_elKey) && _elKey.hasOwnProperty('extensible')) {
                _extensible = _elKey.extensible;
              }
              _schema = _exists(_schema.elements) ? _schema.elements[_pathKeys[_k2]] : _elKey;
              var _key = _exists(_parentPath) && _parentPath.length ? _parentPath + '.' + _pathKeys[_k2] : _pathKeys[_k2];
              if (!_exists(_schema)) {
                if (!_extensible) {
                  return 'element \'' + _pathKeys[_k2] + '\' is not a valid element';
                }
                _schema = {
                  type: '*',
                  required: true,
              ...
              if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object') {
                var _s = !Array.isArray(value) ? new Schema(_schema.elements || _schema, this.options) : _objHelper(_schema, this.options);
                if (typeof _s === 'string') {
                  return s + ' at \'' + key + '\'';
                }
                if (!_exists(_schema) || !_exists(_s) || (typeof _s === 'undefined' ? 'undefined' : _typeof(_s)) !== 'object') {
      ...
      value: function validate() {
        ...
        try {
          for (var _iterator13 = ValidatorBuilder.getInstance().list()[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
  ...
  var _walkSchema = function _walkSchema(obj, path) {
    ...
    for (var _i in _elements) {
      ...
      if (_exists(obj[_k]) && _typeof(obj[_k].elements) === 'object') {
   ...
   * @private
   */
  var _objHelper = function _objHelper(_schema, opts) {
...
var SchemaRoller = function () {
  ...
  _createClass(SchemaRoller, [{
    ...
    value: function getClass() {
      for (var _len4 = arguments.length, classesOrNames = Array(_len4), _key6 = 0; _key6 < _len4; _key6++) {
        classesOrNames[_key6] = arguments[_key6];
      }
      ...
      try {
        for (var _iterator15 = classesOrNames[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
          ...
          if ((typeof arg === 'undefined' ? 'undefined' : _typeof(arg)) === 'object') {
            ...
            if (Array.isArray(arg)) {
              ...
              try {
                for (var _iterator16 = arg[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
                  var n = _step16.value;
