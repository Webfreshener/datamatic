...
_global.JSD = function () {
            ...
            value: function create(ref, path) {
                ...
                var _functs = _signatures.map(function (_sig) {
                    ...
                    if (_sig.hasOwnProperty('*')) {
                        _this11.create(_sig['*'], path);
                        delete _sig['*'];
                        if (Object.keys(_sig) > 0) {
                            return _this11.create(_sig, path);
                        }
                        return;
                    }
            ...
            get: function get() {
                ...
                return {
                    ...
                    set: function set(t, idx, value) {
                        if (!_this13._typeCheck(value)) {
                            // return false;
                            var eMsg = "item at index " + idx + " had wrong type";
                            ObserverBuilder.getInstance().error(_this13.path, eMsg);
                            return false;
                        }
                        t[idx] = value;
                        ObserverBuilder.getInstance().next(_this13.path, t);
                        return true;
                    },
                    deleteProperty: function deleteProperty(t, idx) {
                        if (idx >= t.length) {
                            var e = "index " + idx + " is out of bounds on " + _this13.path;
                            ObserverBuilder.getInstance().error(_this13.path, e);
                            return false;
                        }
                        t.splice(idx, 1);
                        ObserverBuilder.getInstance().next(_this13.path, t);
                ...
                if (!Array.isArray(value)) {
                    ...
                    if (Array.isArray(_kinds)) {
                        _kinds = _kinds.map(function (val) {
                            return _this14.ensureKindIsString(val);
                        });
    ...
    var Schema = function () {
        ...
        function Schema(_signature) {
            ...
            try {
                for (var _iterator11 = Object.keys(_signature)[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
                    var _sigEl2 = _step11.value;
                    ...
                    if (itm instanceof Set) {
                        ...
                        try {
                            for (var _iterator13 = itm.valueOf()[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
                                var _k2 = _step13.value;

                                _arr.push(_derive(itm[_k2]));
                                return _arr;
                            }
                        } catch (err) {
            ...
            get: function get() {
                ...
                return {
                    ...
                    set: function set(t, key, value) {
                        var _sH = _schemaHelpers.get(_this16);
                        ...
                        var _childSigs = _this16.signature.elements || _this16.signature;
                        var _pathKeys = key.split(".");
                        for (var _ in _pathKeys) {
                            var _k4 = _pathKeys[_];
                            var _schema = void 0;
                            // derives path for element
                            var _key = _this16.path.length > 0 ? _this16.path + "." + _k4 : _k4;
                            ...
                            // handles absolute values (strings, numbers, booleans...)
                                    ...
                                    _this16.subscribeTo(_key, {
                                        next: function next(value) {
                                            ObserverBuilder.getInstance().next(_this16.path, value);
                                        },
                                        error: function error(e) {
                                            ObserverBuilder.getInstance().error(_this16.path, e);
                                        }
                                    });
...
_global.wf.Fun.getFunctionName = function (fun) {
    var n = void 0;
...
_global.wf.Fun.construct = function (constructor, args) {
...
_global.wf.Obj.getTypeOf = function (obj) {
...
_global.wf.Str.capitalize = function (string) {
    if (string == null) {
        return '';
    }
...
_global.wf.Str.stripNull = function (string) {
...
_global.wf.Str.regsafe = function (string) {
    if (typeof string === 'undefined') {
        return '';
    }
