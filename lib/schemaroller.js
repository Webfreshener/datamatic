...
_global.SchemaRoller = function () {
  ...
  var BaseValidator = function () {
    ...
    _createClass(BaseValidator, [{
      key: 'iterate',
      value: function iterate(value, evaluator) {
        var _result;
        ...
        try {
          for (var _iterator8 = this.signature[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
      ...
      key: 'derivePolymorphic',
      value: function derivePolymorphic(signature, value) {
        var _attr = this.path.split(".").pop();
  ...
  Validator.Object = function (_BaseValidator) {
    _inherits(Object, _BaseValidator);

    function Object() {
      _classCallCheck(this, Object);

      return _possibleConstructorReturn(this, (Object.__proto__ || Object.getPrototypeOf(Object)).apply(this, arguments));
    }
    ...
    _createClass(Object, [{
      ...
      value: function exec(value) {
        ...
        return this.iterate(value, function (_signature, value) {
          if (!Array.isArray(value)) {
            return _this3.call(_this3.path, _this3.value);
          } else {
            for (var _ in _this3.value) {
              var e = _this3.call(_this3.path, _this3.value[_]);
              if (typeof e === 'string') {
                return e;
              }
            }
   ...
   * @private
   */
  Validator.String = function (_BaseValidator2) {
    _inherits(String, _BaseValidator2);
    ...
    _createClass(String, [{
      ...
      value: function exec(value) {
        ...
        return this.iterate(value, function (signature, value) {
          var _x;
          //			console.log( signature)
          if ((typeof signature === 'undefined' ? 'undefined' : _typeof2(signature)) === 'object') {
          ...
          if (_x === 'Object') {
            ...
            return _this5.derivePolymorphic(signature, value);
          }
          if (signature !== 'String' && !_x.match(/^string$/i)) {
            return _this5.path + ' requires ' + _x + ' type was \'<String>\'';
          }
          if (_exists(signature.restrict)) {
            if (!_exists(new RegExp(signature.restrict).exec(value))) {
              return 'value \'' + value + '\' for ' + _this5.path + ' did not match required expression';
            }
          }
          return true;
        });
   ...
   * @private
   */
  Validator.Number = function (_BaseValidator3) {
    _inherits(Number, _BaseValidator3);
    ...
    _createClass(Number, [{
      ...
      value: function exec(value) {
        ...
        return this.iterate(value, function (signature, value) {
          ...
          // -- is it polymorphic?
          if (_x === 'Object') {
            return _this7.derivePolymorphic(signature, value);
          }
          ...
          if ((_ = _global.wf.wfUtils.Fun.getFunctionName(_x)) !== 'Number') {
            return '\'' + _this7.path + '\' expected ' + _ + ', type was \'<Number>\'';
          }
   ...
   * @private
   */
  Validator.Function = function (_BaseValidator4) {
    _inherits(Function, _BaseValidator4);

    function Function() {
      _classCallCheck(this, Function);

      return _possibleConstructorReturn(this, (Function.__proto__ || Object.getPrototypeOf(Function)).apply(this, arguments));
    }
    ...
    _createClass(Function, [{
      ...
      value: function exec(value) {
        ...
        return this.iterate(value, function (signature, value) {
          ...
          if (_x === 'Object') {
            return _this9.derivePolymorphic(signature, value);
          }
   ...
   * @private
   */
  Validator.Default = function (_BaseValidator5) {
    _inherits(Default, _BaseValidator5);
  ...
  var ValidatorBuilder = function () {
    ...
    _createClass(ValidatorBuilder, [{
      ...
      value: function create(ref, path) {
        ...
        var _signatures = _exists(ref.polymorphic) ? ref.polymorphic : [ref];
        //	  console.log(`create on ${path} ${JSON.stringify(_signatures)}`);
        //	  console.log(this.list());
        return _validators.get(this)[path] = function (value) {
          var _typeof = _global.wf.wfUtils.Str.capitalize(typeof value === 'undefined' ? 'undefined' : _typeof2(value));
          var _hasKey = 0 <= Object.keys(Validator).indexOf(_typeof);
          var _validator = new Validator[_hasKey ? _typeof : "Default"](path, _signatures);
  ...
  var Vector = function () {
    ...
    _createClass(Vector, [{
      ...
      value: function _typeCheck(item) {
        ...
        try {
          for (var _iterator9 = this.type[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
            var _t = _step9.value;
  ...
  var SchemaHelpers = function () {
    ...
    _createClass(SchemaHelpers, [{
      ...
      value: function setObject(obj) {
        var _ = this.hasRequiredFields(Object.assign({}, _object, obj));
        if (typeof _ === 'string') {
          return _;
        }
      ...
      value: function createSchemaChild(key, value, opts, metaData) {
        ...
        if (!Array.isArray(value)) {
          ...
          _kinds = _getKinds(this._ref.signature[key] || this._ref.signature);
  ...
  var Schema = function () {
    ...
    function Schema(_signature) {
      ...
      if (_exists(_signature.elements)) {
        ...
        try {
          for (var _iterator11 = Object.keys(_signature.elements)[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
            var _sigEl = _step11.value;
    ...
    _createClass(Schema, [{
      ...
      value: function validate() {
        ...
        try {
          for (var _iterator12 = ValidatorBuilder.getInstance().list()[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
      ...
      value: function toJSON() {
        ...
        var _derive = function _derive(itm) {
          ...
          if (itm instanceof Vector) {
            ...
            try {
              for (var _iterator13 = itm.valueOf()[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
                var k = _step13.value;
...
var SchemaRoller = function () {
  ...
  _createClass(SchemaRoller, [{
    ...
    value: function getClass() {
      ...
      try {
        for (var _iterator14 = classesOrNames[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
          ...
          if ((typeof arg === 'undefined' ? 'undefined' : _typeof2(arg)) === 'object') {
            ...
            if (Array.isArray(arg)) {
              ...
              try {
                for (var _iterator15 = arg[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
                  var n = _step15.value;
    ...
    value: function fromJSON(json) {
      if (_r = (typeof json === 'undefined' ? 'undefined' : _typeof2(json)).match(/^(string|object)+$/)) {
