...
var SchemaValidator = function () {
  ...
  function SchemaValidator() {
    ...
    try {
      for (var _iterator3 = Object.keys(_schema)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
  ...
  _createClass(SchemaValidator, [{
    ...
    value: function validateSchemaEntry(key, params, opts) {
      ...
      if ((typeof params === 'undefined' ? 'undefined' : _typeof(params)) === "object") {
        ...
        try {
          for (var _iterator8 = Object.keys(params)[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
            var sKey = _step8.value;
            ...
            if (_typeof(_schemaKeys[sKey]) === "object") {
              ...
              if (sKey === "elements") {
                ...
                try {
                  for (var _iterator9 = Object.keys(params.elements)[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                    var xKey = _step9.value;
