            ...
            get: function get() {
                ...
                return {
                    ...
                    set: function set(t, key, value) {
                        var _sH = _schemaHelpers.get(_this15);
                        if ((typeof key === "undefined" ? "undefined" : _typeof2(key)) === 'object') {
                            _sH.setObject(key);
                            return true;
                        }
                        var _childSigs = _this15.signature.elements || _this15.signature;
                        var _pathKeys = key.split(".");
                        for (var _ in _pathKeys) {
                            var _k4 = _pathKeys[_];
                            var _schema = void 0;
                            var _key = _this15.path.length > 0 ? _this15.path + "." + _k4 : _k4;
                            if (_exists(_childSigs["" + _k4])) {
                                ...
                                if (_exists(_childSigs["*"])) {
                                    ...
                                    var _pKey = _this15.path.length > 1 ? _this15.path + "." + key : key;
