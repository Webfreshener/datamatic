...
_global.SchemaRoller = function () {
    ...
    _createClass(BaseValidator, [{
      ...
      value: function checkType(type, value) {
        if (_exists(type)) {
          ...
          if (_x5.match(new RegExp("^" + (typeof value === "undefined" ? "undefined" : _typeof2(value)) + "$", "i")) === null) {
  ...
  Validator.String = function (_BaseValidator3) {
    ...
    _createClass(Str, [{
      key: "exec",
      value: function exec(value) {
        console.log("validate for string");
        console.log(arguments);
        var _ = void 0;
        console.log(this.checkType("string", value));
        if (typeof (_ = this.checkType("string", value)) === "string") {
          console.log("type for " + this.path + " was not 'string'");
          return _;
        }
