...
Schema = (function() {
  ...
  function Schema(_o, opts) {
    var _getKinds, _hasRequiredFields, _oE, _object, _required_elements, _schema_validator, _validate, _validators, _walkSchema, eMsg, escapeKey, i, len, ref, unescapeKey;
    if (_o == null) {
      _o = {};
    }
    if (opts == null) {
